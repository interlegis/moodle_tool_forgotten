...
$PAGE->set_url('/admin/tool/forgotten/forgot_password.php');
...
/// find the user in the database and mail info
    ...
    if (empty($user->email) or !empty($CFG->protectusernames)) {
        ...
        notice(get_string('emailpasswordconfirmmaybesent', 'tool_forgotten'), $CFG->wwwroot.'/index.php');
...
echo $OUTPUT->header();
echo $OUTPUT->box(get_string('passwordforgotteninstructions2', 'tool_forgotten'), 'generalbox boxwidthnormal boxaligncenter');
$mform->display();
