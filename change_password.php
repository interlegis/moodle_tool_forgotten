...
$PAGE->set_url('/admin/tool/forgotten/change_password.php', array('id'=>$id));
...
if ($return) {
    ...
    if (empty($SESSION->wantsurl)
            or stripos(str_replace('https://', 'http://', $SESSION->wantsurl), str_replace('https://', 'http://', $CFG->wwwroot.'/admin/tool/forgotten/change_password.php')) === 0) {
...
if (!isloggedin() or isguestuser()) {
    if (empty($SESSION->wantsurl)) {
        $SESSION->wantsurl = $CFG->httpswwwroot.'/admin/tool/forgotten/change_password.php';
    }
